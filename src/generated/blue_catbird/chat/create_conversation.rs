...
//
// Lexicon: blue.catbird.chat.createConversation
//
...
impl core::fmt::Display for CreateConversationError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Self::ConversationAlreadyExists(msg) => {
                write!(f, "ConversationAlreadyExists")?;
                if let Some(msg) = msg {
                    write!(f, ": {}", msg)?;
                }
                Ok(())
...
/** Response marker for the `blue.catbird.chat.createConversation` procedure.

Implements `jacquard_common::xrpc::XrpcResp`; successful bodies decode as `Self::Output<S>`, which is `CreateConversationOutput<S>` for this endpoint.*/
pub struct CreateConversationResponse;
impl jacquard_common::xrpc::XrpcResp for CreateConversationResponse {
    const NSID: &'static str = "blue.catbird.chat.createConversation";
    const ENCODING: &'static str = "application/json";
    type Output<S: jacquard_common::BosStr> = CreateConversationOutput<S>;
...
/** Endpoint marker for the `blue.catbird.chat.createConversation` procedure.

Path: `/xrpc/blue.catbird.chat.createConversation`. The request payload type is `CreateConversation<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
...
pub struct CreateConversationBuilder<
    St: create_conversation_state::State,
    S: jacquard_common::BosStr = jacquard_common::DefaultStr,
> {
...
impl<S: jacquard_common::BosStr> CreateConversation<S> {
    /// Create a new builder for this type
    pub fn builder() -> CreateConversationBuilder<create_conversation_state::Empty, S> {
        CreateConversationBuilder::builder()
    }
}
...
impl<St, S: jacquard_common::BosStr> CreateConversationBuilder<St, S>
where
    St: create_conversation_state::State,
    St::SignedRequest: create_conversation_state::IsUnset,
{
    /// Set the `signedRequest` field (required)
    pub fn signed_request(
        mut self,
        value: impl Into<crate::generated::blue_catbird::chat::SignedCreation<S>>,
    ) -> CreateConversationBuilder<create_conversation_state::SetSignedRequest<St>, S> {
...
where
    St: create_conversation_state::State,
    St::SignedRequest: create_conversation_state::IsSet,
{
    /// Build the final struct.
    pub fn build(self) -> CreateConversation<S> {
        CreateConversation {
