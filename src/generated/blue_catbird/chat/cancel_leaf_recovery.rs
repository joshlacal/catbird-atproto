...
//
// Lexicon: blue.catbird.chat.cancelLeafRecovery
//
...
impl core::fmt::Display for CancelLeafRecoveryError {
...
/** Response marker for the `blue.catbird.chat.cancelLeafRecovery` procedure.

Implements `jacquard_common::xrpc::XrpcResp`; successful bodies decode as `Self::Output<S>`, which is `CancelLeafRecoveryOutput<S>` for this endpoint.*/
pub struct CancelLeafRecoveryResponse;
impl jacquard_common::xrpc::XrpcResp for CancelLeafRecoveryResponse {
    const NSID: &'static str = "blue.catbird.chat.cancelLeafRecovery";
    const ENCODING: &'static str = "application/json";
    type Output<S: jacquard_common::BosStr> = CancelLeafRecoveryOutput<S>;
...
/** Endpoint marker for the `blue.catbird.chat.cancelLeafRecovery` procedure.

Path: `/xrpc/blue.catbird.chat.cancelLeafRecovery`. The request payload type is `CancelLeafRecovery<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
...
pub struct CancelLeafRecoveryBuilder<
    St: cancel_leaf_recovery_state::State,
    S: jacquard_common::BosStr = jacquard_common::DefaultStr,
> {
...
impl<S: jacquard_common::BosStr> CancelLeafRecovery<S> {
    /// Create a new builder for this type
    pub fn builder() -> CancelLeafRecoveryBuilder<cancel_leaf_recovery_state::Empty, S> {
        CancelLeafRecoveryBuilder::builder()
    }
}
...
impl<St, S: jacquard_common::BosStr> CancelLeafRecoveryBuilder<St, S>
where
    St: cancel_leaf_recovery_state::State,
    St::SignedRequest: cancel_leaf_recovery_state::IsUnset,
{
...
where
    St: cancel_leaf_recovery_state::State,
    St::SignedRequest: cancel_leaf_recovery_state::IsSet,
{
    /// Build the final struct.
    pub fn build(self) -> CancelLeafRecovery<S> {
        CancelLeafRecovery {
