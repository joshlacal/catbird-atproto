...
//
// Lexicon: blue.catbird.chat.activateReset
//
...
impl core::fmt::Display for ActivateResetError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Self::InvalidGenesisGroupInfo(msg) => {
                write!(f, "InvalidGenesisGroupInfo")?;
                if let Some(msg) = msg {
                    write!(f, ": {}", msg)?;
                }
                Ok(())
            ...
            Self::InvalidMlsArtifact(msg) => {
                write!(f, "InvalidMlsArtifact")?;
                if let Some(msg) = msg {
                    write!(f, ": {}", msg)?;
                }
                Ok(())
            ...
            Self::ResetRequestNotFound(msg) => {
                write!(f, "ResetRequestNotFound")?;
                if let Some(msg) = msg {
                    write!(f, ": {}", msg)?;
                }
                Ok(())
            }
            Self::ResetRequestStale(msg) => {
                write!(f, "ResetRequestStale")?;
                if let Some(msg) = msg {
                    write!(f, ": {}", msg)?;
                }
                Ok(())
...
/** Response marker for the `blue.catbird.chat.activateReset` procedure.

Implements `jacquard_common::xrpc::XrpcResp`; successful bodies decode as `Self::Output<S>`, which is `ActivateResetOutput<S>` for this endpoint.*/
pub struct ActivateResetResponse;
impl jacquard_common::xrpc::XrpcResp for ActivateResetResponse {
    const NSID: &'static str = "blue.catbird.chat.activateReset";
    const ENCODING: &'static str = "application/json";
    type Output<S: jacquard_common::BosStr> = ActivateResetOutput<S>;
...
/** Endpoint marker for the `blue.catbird.chat.activateReset` procedure.

Path: `/xrpc/blue.catbird.chat.activateReset`. The request payload type is `ActivateReset<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
...
pub struct ActivateResetBuilder<
    St: activate_reset_state::State,
...
impl<S: jacquard_common::BosStr> ActivateReset<S> {
    /// Create a new builder for this type
    pub fn builder() -> ActivateResetBuilder<activate_reset_state::Empty, S> {
        ActivateResetBuilder::builder()
    }
}

impl ActivateResetBuilder<activate_reset_state::Empty, jacquard_common::DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
        ActivateResetBuilder {
...
impl<S: jacquard_common::BosStr> ActivateResetBuilder<activate_reset_state::Empty, S> {
...
impl<St, S: jacquard_common::BosStr> ActivateResetBuilder<St, S>
where
    St: activate_reset_state::State,
    St::SignedRequest: activate_reset_state::IsUnset,
{
    /// Set the `signedRequest` field (required)
    pub fn signed_request(
        mut self,
        value: impl Into<crate::generated::blue_catbird::chat::SignedResetActivation<S>>,
    ) -> ActivateResetBuilder<activate_reset_state::SetSignedRequest<St>, S> {
...
where
    St: activate_reset_state::State,
    St::SignedRequest: activate_reset_state::IsSet,
{
    /// Build the final struct.
    pub fn build(self) -> ActivateReset<S> {
        ActivateReset {
