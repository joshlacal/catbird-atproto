...
fn lexicon_doc_blue_catbird_mlsChat_declaration() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
        ...
        defs: {
                    ...
                    properties: {
                        ...
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::String(::jacquard_lexicon::lexicon::LexString {
                                description: Some(
                                    ::jacquard_common::CowStr::new_static("Who can message me"),
                                ),
                                format: None,
                                default: None,
                                min_length: None,
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![
                            ...
                            ::jacquard_common::smol_str::SmolStr::new_static("deviceMlsSignaturePublicKey")
                        ],
                    ),
                    nullable: None,
                    properties: {
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    properties: {
                        ...
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Ref(::jacquard_lexicon::lexicon::LexRef {
                                description: None,
                                r#ref: ::jacquard_common::CowStr::new_static("#deviceProof"),
                            }),
                        );
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("sig"),
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![
                            ::jacquard_common::smol_str::SmolStr::new_static("newOnlineRootPublicKey"),
...
pub struct Declaration<'a> {
    ...
    pub prev: std::option::Option<
        crate::generated::blue_catbird::mlsChat::declaration::PrevLink<'a>,
    >,
...
pub struct DeclarationBuilder<'a, S: declaration_state::State> {
    ...
    __unsafe_private_named: (
        ...
        >,
        ::core::option::Option<
            crate::generated::blue_catbird::mlsChat::declaration::Proofs<'a>,
        >,
        ::core::option::Option<i64>,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
...
impl<'a, S: declaration_state::State> DeclarationBuilder<'a, S> {
    ...
    pub fn prev(
        mut self,
        value: impl Into<
            Option<crate::generated::blue_catbird::mlsChat::declaration::PrevLink<'a>>,
        >,
    ) -> Self {
...
pub enum DeclarationEvent<'a> {
    ...
    DeviceRevoke(
        Box<crate::generated::blue_catbird::mlsChat::declaration::DeviceRevoke<'a>>,
    ),
    #[serde(rename = "blue.catbird.mlsChat.declaration#rootRotate")]
    RootRotate(
        Box<crate::generated::blue_catbird::mlsChat::declaration::RootRotate<'a>>,
    ),
    #[serde(rename = "blue.catbird.mlsChat.declaration#recoveryRotateOnlineRoot")]
    RecoveryRotateOnlineRoot(
        Box<
            crate::generated::blue_catbird::mlsChat::declaration::RecoveryRotateOnlineRoot<
                'a,
            >,
        >,
    ),
...
pub struct Proofs<'a> {
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub device_proof: std::option::Option<
...
impl<'a, S: proofs_state::State> ProofsBuilder<'a, S> {
    ...
    pub fn device_proof(
        mut self,
        value: impl Into<
            Option<crate::generated::blue_catbird::mlsChat::declaration::DeviceProof<'a>>,
        >,
    ) -> Self {
        self.__unsafe_private_named.2 = value.into();
        self
...
/// Builder for constructing an instance of this type
pub struct RecoveryRotateOnlineRootBuilder<
    'a,
...
impl<'a> RecoveryRotateOnlineRoot<'a> {
    /// Create a new builder for this type
    pub fn new() -> RecoveryRotateOnlineRootBuilder<
        'a,
        recovery_rotate_online_root_state::Empty,
    > {
...
impl<
    'a,
    S: recovery_rotate_online_root_state::State,
> RecoveryRotateOnlineRootBuilder<'a, S> {
