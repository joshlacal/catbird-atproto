...
pub struct Device<'a> {
    ...
    /// Unique device identifier (server-assigned or client-generated UUID)
    #[serde(borrow)]
    ...
    /// Device platform: 'ios', 'macos', 'catmos', 'android'
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
...
where
    S: device_state::State,
    S::DeviceId: device_state::IsUnset,
{
    /// Set the `deviceId` field (required)
    pub fn device_id(
        mut self,
        value: impl Into<jacquard_common::CowStr<'a>>,
    ) -> DeviceBuilder<'a, device_state::SetDeviceId<S>> {
...
impl<'a, S: device_state::State> DeviceBuilder<'a, S> {
...
impl<'a, S: device_state::State> DeviceBuilder<'a, S> {
    ...
    pub fn platform(mut self, value: impl Into<Option<jacquard_common::CowStr<'a>>>) -> Self {
        self.__unsafe_private_named.5 = value.into();
        self
    }
    /// Set the `platform` field to an Option value (optional)
    pub fn maybe_platform(mut self, value: Option<jacquard_common::CowStr<'a>>) -> Self {
    ...
    S::MlsSignaturePublicKey: device_state::IsSet,
{
    ...
    pub fn build(self) -> Device<'a> {
        Device {
            ...
            device_name: self.__unsafe_private_named.3,
            mls_signature_public_key: self.__unsafe_private_named.4.unwrap(),
            platform: self.__unsafe_private_named.5,
