...
pub struct DisableAccountInvites<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> jacquard_common::xrpc::XrpcRequest for DisableAccountInvites<S> {
    const NSID: &'static str = "com.atproto.admin.disableAccountInvites";
...
impl jacquard_common::xrpc::XrpcEndpoint for DisableAccountInvitesRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod =
        jacquard_common::xrpc::XrpcMethod::Procedure("application/json");
    type Request<S: jacquard_common::BosStr> = DisableAccountInvites<S>;
    type Response = DisableAccountInvitesResponse;
}
...
impl DisableAccountInvites<jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> DisableAccountInvites<S> {
...
impl
    DisableAccountInvitesBuilder<disable_account_invites_state::Empty, jacquard_common::DefaultStr>
{
...
impl<S: jacquard_common::BosStr>
    DisableAccountInvitesBuilder<disable_account_invites_state::Empty, S>
{
...
impl<St, S: jacquard_common::BosStr> DisableAccountInvitesBuilder<St, S>
where
    St: disable_account_invites_state::State,
...
impl<St: disable_account_invites_state::State, S: jacquard_common::BosStr>
