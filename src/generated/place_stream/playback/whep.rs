...
pub struct WhepParams<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    pub rendition: S,
    pub streamer: S,
}
...
impl jacquard_common::xrpc::XrpcResp for WhepResponse {
    ...
    type Output<S: jacquard_common::BosStr> = WhepOutput;
    type Err = WhepError;
...
impl<S: jacquard_common::BosStr> WhepParams<S> {
...
impl WhepParamsBuilder<whep_params_state::Empty, jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> WhepParamsBuilder<whep_params_state::Empty, S> {
...
impl<St, S: jacquard_common::BosStr> WhepParamsBuilder<St, S>
where
    St: whep_params_state::State,
