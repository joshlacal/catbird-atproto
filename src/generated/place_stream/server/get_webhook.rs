...
pub struct GetWebhook<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    pub id: S,
}
...
impl jacquard_common::xrpc::XrpcResp for GetWebhookResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetWebhookOutput<S>;
    type Err = GetWebhookError;
}

impl<S: jacquard_common::BosStr> jacquard_common::xrpc::XrpcRequest for GetWebhook<S> {
    const NSID: &'static str = "place.stream.server.getWebhook";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetWebhookRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetWebhook<S>;
    type Response = GetWebhookResponse;
}
...
impl<S: jacquard_common::BosStr> GetWebhook<S> {
...
impl GetWebhookBuilder<get_webhook_state::Empty, jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> GetWebhookBuilder<get_webhook_state::Empty, S> {
...
impl<St, S: jacquard_common::BosStr> GetWebhookBuilder<St, S>
where
    St: get_webhook_state::State,
