...
impl jacquard_common::xrpc::XrpcResp for UpdateLivestreamResponse {
    ...
    type Output<S: jacquard_common::BosStr> = UpdateLivestreamOutput<S>;
...
impl<S: jacquard_common::BosStr> UpdateLivestream<S> {
...
impl<St, S: jacquard_common::BosStr> UpdateLivestreamBuilder<St, S>
where
    St: update_livestream_state::State,
