...
pub struct AcceptConvo<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    pub convo_id: S,
    #[serde(
        flatten,
        default,
...
pub struct AcceptConvoOutput<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    ///Rev when the convo was accepted. If not present, the convo was already accepted.
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub rev: core::option::Option<S>,
    #[serde(
        flatten,
        default,
        skip_serializing_if = "core::option::Option::is_none"
...
impl jacquard_common::xrpc::XrpcResp for AcceptConvoResponse {
    ...
    type Output<S: jacquard_common::BosStr> = AcceptConvoOutput<S>;
    type Err = AcceptConvoError;
}

impl<S: jacquard_common::BosStr> jacquard_common::xrpc::XrpcRequest for AcceptConvo<S> {
    const NSID: &'static str = "chat.bsky.convo.acceptConvo";
...
impl jacquard_common::xrpc::XrpcEndpoint for AcceptConvoRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod =
        jacquard_common::xrpc::XrpcMethod::Procedure("application/json");
    type Request<S: jacquard_common::BosStr> = AcceptConvo<S>;
    type Response = AcceptConvoResponse;
}
