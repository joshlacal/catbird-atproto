...
pub struct SearchStarterPacksSkeletonOutput<
...
impl jacquard_common::xrpc::XrpcResp for SearchStarterPacksSkeletonResponse {
    ...
    type Output<S: jacquard_common::BosStr> = SearchStarterPacksSkeletonOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for SearchStarterPacksSkeletonRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = SearchStarterPacksSkeleton<S>;
    type Response = SearchStarterPacksSkeletonResponse;
}
...
impl SearchStarterPacksSkeleton<jacquard_common::DefaultStr> {
...
impl<St, S: jacquard_common::BosStr> SearchStarterPacksSkeletonBuilder<St, S>
where
    St: search_starter_packs_skeleton_state::State,
