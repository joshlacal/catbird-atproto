...
pub struct GetOnboardingSuggestedUsersSkeleton<
...
impl jacquard_common::xrpc::XrpcEndpoint for GetOnboardingSuggestedUsersSkeletonRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetOnboardingSuggestedUsersSkeleton<S>;
    type Response = GetOnboardingSuggestedUsersSkeletonResponse;
}
...
impl GetOnboardingSuggestedUsersSkeleton<jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> GetOnboardingSuggestedUsersSkeleton<S> {
...
impl<St, S: jacquard_common::BosStr> GetOnboardingSuggestedUsersSkeletonBuilder<St, S>
where
    St: get_onboarding_suggested_users_skeleton_state::State,
{
