...
impl jacquard_common::xrpc::XrpcResp for GetSuggestedUsersSkeletonResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetSuggestedUsersSkeletonOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetSuggestedUsersSkeletonRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetSuggestedUsersSkeleton<S>;
    type Response = GetSuggestedUsersSkeletonResponse;
}
...
impl GetSuggestedUsersSkeleton<jacquard_common::DefaultStr> {
...
impl<St, S: jacquard_common::BosStr> GetSuggestedUsersSkeletonBuilder<St, S>
where
    St: get_suggested_users_skeleton_state::State,
{
