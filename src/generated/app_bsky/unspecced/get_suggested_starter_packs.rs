...
pub struct GetSuggestedStarterPacksOutput<S: jacquard_common::BosStr = jacquard_common::DefaultStr>
{
...
impl jacquard_common::xrpc::XrpcResp for GetSuggestedStarterPacksResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetSuggestedStarterPacksOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetSuggestedStarterPacksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetSuggestedStarterPacks;
    type Response = GetSuggestedStarterPacksResponse;
}
