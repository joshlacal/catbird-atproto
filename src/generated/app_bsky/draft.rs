...
pub struct DraftEmbedImage<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
...
pub struct DraftEmbedVideo<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub alt: core::option::Option<S>,
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub captions:
...
impl<S: jacquard_common::BosStr> jacquard_lexicon::schema::LexiconSchema for Draft<S> {
    fn nsid() -> &'static str {
        "app.bsky.draft.defs"
    }
...
impl Draft<jacquard_common::DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> DraftBuilder<draft_state::Empty, jacquard_common::DefaultStr> {
        DraftBuilder::new()
    }
}

impl<S: jacquard_common::BosStr> Draft<S> {
...
impl DraftBuilder<draft_state::Empty, jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> DraftBuilder<draft_state::Empty, S> {
...
impl<St: draft_state::State, S: jacquard_common::BosStr> DraftBuilder<St, S> {
...
impl<St, S: jacquard_common::BosStr> DraftBuilder<St, S>
where
    St: draft_state::State,
    St::Posts: draft_state::IsUnset,
{
    ...
    pub fn posts(
        mut self,
        value: impl Into<Vec<crate::generated::app_bsky::draft::DraftPost<S>>>,
...
impl<S: jacquard_common::BosStr> DraftEmbedCaption<S> {
    /// Create a new builder for this type
...
impl<St, S: jacquard_common::BosStr> DraftEmbedCaptionBuilder<St, S>
where
    St: draft_embed_caption_state::State,
...
impl<S: jacquard_common::BosStr> DraftEmbedExternal<S> {
    /// Create a new builder for this type
...
impl<St, S: jacquard_common::BosStr> DraftEmbedExternalBuilder<St, S>
where
    St: draft_embed_external_state::State,
...
impl<S: jacquard_common::BosStr> DraftEmbedGallery<S> {
    /// Create a new builder for this type
...
impl<St, S: jacquard_common::BosStr> DraftEmbedGalleryBuilder<St, S>
where
    St: draft_embed_gallery_state::State,
    St::Items: draft_embed_gallery_state::IsUnset,
{
    ...
    pub fn items(
        mut self,
        value: impl Into<crate::generated::app_bsky::draft::DraftEmbedGalleryItems<S>>,
...
impl<S: jacquard_common::BosStr> DraftEmbedImage<S> {
    /// Create a new builder for this type
...
impl<St, S: jacquard_common::BosStr> DraftEmbedImageBuilder<St, S>
where
    St: draft_embed_image_state::State,
    St::LocalRef: draft_embed_image_state::IsUnset,
{
    ...
    pub fn local_ref(
        mut self,
        value: impl Into<crate::generated::app_bsky::draft::DraftEmbedLocalRef<S>>,
...
impl<S: jacquard_common::BosStr> DraftEmbedRecord<S> {
    /// Create a new builder for this type
...
impl<St, S: jacquard_common::BosStr> DraftEmbedRecordBuilder<St, S>
where
    St: draft_embed_record_state::State,
...
impl<S: jacquard_common::BosStr> DraftEmbedVideo<S> {
    /// Create a new builder for this type
...
impl<St: draft_embed_video_state::State, S: jacquard_common::BosStr> DraftEmbedVideoBuilder<St, S> {
    ...
    pub fn maybe_captions(
        mut self,
        value: Option<Vec<crate::generated::app_bsky::draft::DraftEmbedCaption<S>>>,
    ) -> Self {
        self._fields.1 = value;
        self
    }
...
impl<St, S: jacquard_common::BosStr> DraftEmbedVideoBuilder<St, S>
where
    St: draft_embed_video_state::State,
...
> {
    ...
    _fields: (
        ...
        core::option::Option<crate::generated::app_bsky::draft::Draft<S>>,
...
impl<S: jacquard_common::BosStr> DraftView<S> {
    /// Create a new builder for this type
...
impl DraftViewBuilder<draft_view_state::Empty, jacquard_common::DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
        DraftViewBuilder {
            _state: ::core::marker::PhantomData,
...
impl<S: jacquard_common::BosStr> DraftViewBuilder<draft_view_state::Empty, S> {
    /// Create a new builder with all fields unset
    pub fn builder() -> Self {
        DraftViewBuilder {
            _state: ::core::marker::PhantomData,
...
impl<St, S: jacquard_common::BosStr> DraftViewBuilder<St, S>
where
    St: draft_view_state::State,
...
impl<S: jacquard_common::BosStr> DraftWithId<S> {
    /// Create a new builder for this type
...
impl DraftWithIdBuilder<draft_with_id_state::Empty, jacquard_common::DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
        DraftWithIdBuilder {
            _state: ::core::marker::PhantomData,
...
impl<S: jacquard_common::BosStr> DraftWithIdBuilder<draft_with_id_state::Empty, S> {
    /// Create a new builder with all fields unset
    pub fn builder() -> Self {
        DraftWithIdBuilder {
            _state: ::core::marker::PhantomData,
...
impl<St, S: jacquard_common::BosStr> DraftWithIdBuilder<St, S>
where
    St: draft_with_id_state::State,
