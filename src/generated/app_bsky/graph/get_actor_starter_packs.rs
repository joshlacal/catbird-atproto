...
impl jacquard_common::xrpc::XrpcResp for GetActorStarterPacksResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetActorStarterPacksOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetActorStarterPacksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetActorStarterPacks<S>;
    type Response = GetActorStarterPacksResponse;
}
...
impl GetActorStarterPacks<jacquard_common::DefaultStr> {
...
impl<St, S: jacquard_common::BosStr> GetActorStarterPacksBuilder<St, S>
where
    St: get_actor_starter_packs_state::State,
