...
impl jacquard_common::xrpc::XrpcResp for SearchStarterPacksV2Response {
    ...
    type Output<S: jacquard_common::BosStr> = SearchStarterPacksV2Output<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for SearchStarterPacksV2Request {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = SearchStarterPacksV2<S>;
    type Response = SearchStarterPacksV2Response;
}
...
impl SearchStarterPacksV2<jacquard_common::DefaultStr> {
...
impl<St, S: jacquard_common::BosStr> SearchStarterPacksV2Builder<St, S>
where
    St: search_starter_packs_v2_state::State,
