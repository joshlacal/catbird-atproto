...
pub struct GetFollowers<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
...
pub struct GetFollowersOutput<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    pub cursor: core::option::Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetFollowersResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetFollowersOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: jacquard_common::BosStr> jacquard_common::xrpc::XrpcRequest for GetFollowers<S> {
    const NSID: &'static str = "app.bsky.graph.getFollowers";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetFollowersRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetFollowers<S>;
    type Response = GetFollowersResponse;
}
...
pub struct GetFollowersBuilder<
...
impl<S: jacquard_common::BosStr> GetFollowers<S> {
...
impl GetFollowersBuilder<get_followers_state::Empty, jacquard_common::DefaultStr> {
...
impl<S: jacquard_common::BosStr> GetFollowersBuilder<get_followers_state::Empty, S> {
