...
pub struct GetKnownFollowers<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
...
impl jacquard_common::xrpc::XrpcResp for GetKnownFollowersResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetKnownFollowersOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetKnownFollowersRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetKnownFollowers<S>;
    type Response = GetKnownFollowersResponse;
}
...
impl<S: jacquard_common::BosStr> GetKnownFollowers<S> {
...
impl<St, S: jacquard_common::BosStr> GetKnownFollowersBuilder<St, S>
where
    St: get_known_followers_state::State,
