...
pub struct GetStarterPacks<S: jacquard_common::BosStr = jacquard_common::DefaultStr> {
...
impl jacquard_common::xrpc::XrpcResp for GetStarterPacksResponse {
    ...
    type Output<S: jacquard_common::BosStr> = GetStarterPacksOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetStarterPacksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: jacquard_common::BosStr> = GetStarterPacks<S>;
    type Response = GetStarterPacksResponse;
}
...
impl<S: jacquard_common::BosStr> GetStarterPacks<S> {
...
impl<St, S: jacquard_common::BosStr> GetStarterPacksBuilder<St, S>
where
    St: get_starter_packs_state::State,
